...
/***************************************************************************
 NDVIGenerator
                                 A QGIS plugin
 This plugin generates NDVI.
 Generated by Plugin Builder: http://g-sherman.github.io/Qgis-Plugin-Builder/
                              -------------------
        begin                : 2022-03-07
        git sha              : $Format:%H$
        copyright            : (C) 2022 by AiswaryaVV
...
class NDVIGenerator:
    ...
    def __init__(self, iface):
        ...
        locale_path = os.path.join(
            self.plugin_dir,
            'i18n',
            'NDVIGenerator_{}.qm'.format(locale))
        ...
        self.actions = []
        self.menu = self.tr(u'&NDVI Generator')
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('NDVIGenerator', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/ndvi_generator/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'NDVI Generator'),
            callback=self.run,
    ...
    def run(self):
        ...
        if result:
            ...
            self.final()
            #inputfile1 = (self.dlg.comboBox.currentText())
            #inputfile2 = (self.dlg.comboBox_2.currentText())
            #outputfile = self.dlg.lineEdit.text()
            #b1 = iface.addRasterLayer(inputfile1,"b1","gdal")
            #b2 = iface.addRasterLayer(inputfile2,"b2","gdal")
            #exp = (b1 - b2) / (b1 + b2)
            #ndvi = QgsRasterCalculator(exp, outputfile, "GTiff")
